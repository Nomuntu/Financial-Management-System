...
# ✅ Use fully-qualified imports for package context
...
def list_customers(
    ...
    """
    List all customers for the organization from the JWT payload.
    """
...
def create_customer(
    ...
    """
    Create a new customer linked to the organization in the JWT token.
    """
    org_id = payload.get("org")
    row = models.Customer(
